...
add_action(
	'widgets_init', function() {
		return register_widget( 'Snazzy_Flickr_Widget' );
	}
);

class Snazzy_Flickr_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'bean_flickr',
			esc_html__( 'Flickr Photos', '@@textdomain' ),
			array( 'description' => esc_html__( 'Add a Flickr feed widget.', '@@textdomain' ) )
		);
	}
...
<p><?php echo balanceTags( $desc ); ?></p><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title / Intro:', '@@textdomain' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'flickrID' ) ); ?>"><?php _e( 'Flickr ID:', '@@textdomain' ); ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php _e( 'Type:', '@@textdomain' ); ?></label>
...
>Group</option>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php _e( 'Display:', '@@textdomain' ); ?></label>
