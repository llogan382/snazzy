...
class ThemeBeans_License_Control extends WP_Customize_Control {
	...
	protected function content_template() {
		...
		<div id="theme-license-form" class="license-form">
			...
			<input type="submit" name="themebeans-license" id="themebeans-activate-license" value="<?php esc_attr_e( 'Activate', '@@textdomain' ); ?>" class="button-secondary button {{ data.visibility }}">
			<input type="submit" name="themebeans-deactivate-license" id="themebeans-deactivate-license" value="<?php esc_attr_e( 'Deactivate', '@@textdomain' ); ?>" class="button-secondary button {{ data.visibility }}">
		...
		<ul id="theme-license-info" class="{{ data.visibility }}">
			<li><strong><?php esc_html_e( 'Status:', '@@textdomain' ); ?></strong> <span id="theme-license-status">{{ data.status }}</span></li>
		</ul>
