	...
	public function render() {
		...
		<div class="huh-launcher">
			<button class="huh-launcher--button" id="huh-launcher--button" data-accent-color="<?php echo esc_attr( $huh_accent_color ); ?>" data-text-color="<?php echo esc_attr( $huh_text_color ); ?>">
				...
				<span class="screen-reader-text"><?php echo esc_html__( 'Need help?', '@@textdomain' ); ?></span>
			</button>
		</div>

		<div id="huh-container" class="huh-container">
			<div class="huh-container__header" id="huh-header">
				<h4 class="huh-container__header-text"><?php echo esc_attr( themebeans_get_theme( false ) ); ?> <?php echo esc_html__( 'WordPress Theme', '@@textdomain' ); ?> </h4>
				<a id="huh-back-trigger" class="huh-container__header-text huh-container__header-text--back" href="javascript:;">
					...
					<?php echo esc_html__( 'Back', '@@textdomain' ); ?>
				</a>
			...
			<form class="huh-container__search" target="_blank" action="https://kb.themebeans.com/search?query=">
				<input id="huh-search-form" name="query" type="text" placeholder="<?php echo esc_html__( 'Search our Help Center...', '@@textdomain' ); ?>"/>
				<input id="huh-search-button" type="submit" value="<?php echo esc_html__( 'Search', '@@textdomain' ); ?>" class="button button-secondary huh-container__search-submit">
			</form>
		</div>
		<?php
	}
