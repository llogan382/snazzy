...
function snazzy_register_required_plugins() {
	...
	$args = array(
		...
		array(
			'name'     => esc_html__( 'Portfolio Post Type', 'snazzy' ),
			'slug'     => 'portfolio-post-type',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Simple Post Ordering', 'snazzy' ),
			'slug'     => 'simple-custom-post-order',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Contact Form 7', 'snazzy' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
	);
	 ...
	 */
	$config = array(
		'id'           => 'snazzy',          // Unique ID for hashing notices for multiple instances of TGMPA.
