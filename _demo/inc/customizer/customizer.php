...
function snazzy_customize_controls_js() {
	wp_enqueue_script( 'snazzy-customize-controls', get_theme_file_uri( '/assets/js/admin/customize-controls' . SNAZZY_ASSET_SUFFIX . '.js' ), array( 'customize-controls' ), '3.2.8', true );
}
...
function snazzy_customize_preview_js() {
	wp_enqueue_script( 'snazzy-customize-preview', get_theme_file_uri( 'assets/js/admin/customize-preview' . SNAZZY_ASSET_SUFFIX . '.js' ), array( 'customize-preview' ), '3.2.8', true );
}
