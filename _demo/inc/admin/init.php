 ...
 *
 * ThemeBeans Core: v1.4.9
 * New: Merlin WP 1.0 and Merlin After Import
 *
 * @package     Snazzy
...
if ( ! function_exists( 'themebeans_admin_init' ) ) :
	 ...
	 */
	function themebeans_admin_init() {
		add_action( 'wp_head', 'themebeans_meta_generator', 0 );
 ...
 * Metabox functions.
 */
require get_parent_theme_file_path( THEMEBEANS_ADMIN_DIR . '/metaboxes.php' );
