...
class ThemeBeans_Layout_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		// Localization.
		$themebeans_layout_control_l10n['open']  = esc_html__( 'Layout', 'snazzy' );
		$themebeans_layout_control_l10n['close'] = esc_html__( 'Close', 'snazzy' );
	...
	protected function content_template() {
		...
		<button id="layout-switcher" class="button layout-switcher"><?php esc_html_e( 'Layout', 'snazzy' ); ?></button>
