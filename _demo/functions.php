...
if ( ! function_exists( 'snazzy_setup' ) ) :
	...
	function snazzy_setup() {
		...
		/**
		 * Filters Snazzy array of starter content.
		 *
		 * @since Snazzy 1.0
		 *
...
function snazzy_scripts() {
	...
	if ( is_child_theme() ) {
		...
		wp_enqueue_style( 'snazzy-child-style', get_theme_file_uri( '/style.css' ), false, '3.2.8', 'all' );
	} else {
	...
	if ( SCRIPT_DEBUG || SNAZZY_DEBUG ) {
		// Vendor scripts.
		wp_enqueue_script( 'picturefill', get_theme_file_uri( '/assets/js/vendors/picturefill.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'unveil', get_theme_file_uri( '/assets/js/vendors/unveil.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'isotope', get_theme_file_uri( '/assets/js/vendors/isotope.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'infinitescroll', get_theme_file_uri( '/assets/js/vendors/infinitescroll.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'fitvids', get_theme_file_uri( '/assets/js/vendors/fitvids.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'snazzy-photoswipe', get_theme_file_uri( '/assets/js/vendors/photoswipe.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'snazzy-photoswipe-ui', get_theme_file_uri( '/assets/js/vendors/photoswipe-ui-default.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'lity', get_theme_file_uri( '/assets/js/vendors/lity.js' ), array( 'jquery' ), '3.2.8', true );

		// Custom scripts.
		wp_enqueue_script( 'snazzy-global', get_theme_file_uri( '/assets/js/custom/global.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'snazzy-imagesloaded', get_theme_file_uri( '/assets/js/vendors/images-loaded.js' ), array( 'jquery' ), '3.2.8', true );

	} else {
		wp_enqueue_script( 'snazzy-vendors-min', get_theme_file_uri( '/assets/js/vendors.min.js' ), array( 'jquery' ), '3.2.8', true );
		wp_enqueue_script( 'snazzy-custom-min', get_theme_file_uri( '/assets/js/custom.min.js' ), array( 'jquery' ), '3.2.8', true );
	}
	...
	if ( is_page_template( 'template-contact.php' ) ) {
		wp_enqueue_script( 'validation', 'https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js', array( 'jquery' ), '3.2.8', true );
	}
}
 ...
 *
 * Since v3.2.3 Snazzy has a built-in auto-loader for loading the appropriate
...
function snazzy_enqueue_admin_style() {
	wp_enqueue_style( 'snazzy-admin', get_theme_file_uri( '/assets/css/admin-style.css' ), false, '3.2.8', 'all' );
}
...
function snazzy_enqueue_admin_script( $hook ) {
	if ( 'edit.php' !== $hook ) {
		wp_enqueue_script( 'snazzy-post-meta', get_theme_file_uri( '/assets/js/admin/post-meta.js' ), array( 'jquery' ), '3.2.8', true );
	}
}
...
/**
 * Load Portfolio Pro compatibility file.
 */
require get_theme_file_path( '/inc/portfolio-pro.php' );
