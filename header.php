		...
		<div id="content" class="site-content content-wrap">
			...
			<?php if ( has_nav_menu( 'primary' ) ) : ?>
				...
				<nav id="site-navigation" class="main-navigation" role="navigation">
					...
					<h6 class="widget-title"><?php esc_html_e( 'Menu', '@@textdomain' ); ?></h6>
			...
			if ( snazzy_is_frontpage() || is_tax() || is_archive( 'portfolio' ) ) {
			...
			<div class="site-info">
				...
				<a href="https://themebeans.com/themes/snazzy/" class="powered-by-snazzy <?php echo esc_attr( $visibility ); ?>"><?php printf( esc_html__( 'Powered by %s', '@@textdomain' ), 'Snazzy' ); ?></a>

				<?php $visibility = ( false === get_theme_mod( 'powered_by_wordpress' ) ) ? 'hidden' : ''; ?>

				<a href="http://wordpress.org/" class="powered-by-wordpress <?php echo esc_attr( $visibility ); ?>"><?php printf( esc_html__( '& %s', '@@textdomain' ), 'WordPress' ); ?></a>
