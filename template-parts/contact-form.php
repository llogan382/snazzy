...
if(isset($emailSent) && $emailSent == true ) : ?>
    ...
    <div class="contact-alert success">
        <?php echo apply_filters( 'bean_contactform_success_msg', esc_html__('Your message was sent. Thanks.', '@@textdomain') ); ?>
    </div>
...
if(isset($hasError) || isset($captchaError)) : ?>
    ...
    <div class="contact-alert fail">
        <?php echo apply_filters( 'bean_contactform_error_msg', esc_html__('An error occured. Try again.', '@@textdomain') ); ?>
    </div>
...
<form xid="contact-form" class="bean-contact-form" method="post" id="contact-form" >
    ...
    <div class="group name">
        <label for="messageName"><?php echo apply_filters( 'bean_contactform_name_label', esc_html__('Name', '@@textdomain') ); ?></label>
    ...
    <div class="group email">
        <label for="messageEmail"><?php echo apply_filters( 'bean_contactform_email_label', esc_html__('Email', '@@textdomain') ); ?></label>
    ...
    <div class="group message last">
        <label for="messageContent"><?php echo apply_filters( 'bean_contactform_message_label', esc_html__('Message', '@@textdomain') ); ?></label>
    ...
    <div class="submit">
        ...
        <button type="submit" class="button"><?php echo esc_html( get_theme_mod('contact_button', 'Send') );?></button>
    </div>
