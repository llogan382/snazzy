...
<div class="widget project-filter project-filterer <?php echo esc_html( $visibility ); ?>">
    ...
    <h6 class="widget-title">
         ...
         */
        if ( !is_tax() ) :
            esc_html_e( 'Filter', '@@textdomain' );
        else:
            esc_html_e( 'Archive', '@@textdomain' );
        endif; ?>
    </h6>
    ...
    <ul class="filter-group">
        ...
        <?php if ( !is_tax() ) : ?>
            <li><a href="javascript:void(0);" id="filter-close" data-filter="*"><?php esc_html_e( 'All' , '@@textdomain' ); ?></a></li>
        <?php endif;
...
<div class="widget project-filter project-sorter <?php echo esc_html( $visibility ); ?>">
    ...
    <h6 class="widget-title"><?php esc_html_e( 'Sort', '@@textdomain' ); ?></h6>

    <ul class="sort-group">

        <li><a href="javascript:void(0);" class="shuffle-btn"><?php esc_html_e( 'Random' , '@@textdomain' ); ?></a></li>
        <li><a href="javascript:void(0);" data-sort-by="views"><?php esc_html_e( 'Popularity' , '@@textdomain' ); ?></a></li>
        <li><a href="javascript:void(0);" data-sort-by="date"><?php esc_html_e( 'Date' , '@@textdomain' ); ?></a></li>
